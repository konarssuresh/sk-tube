...
- Autoplay videos when opened from the channel feed using the YouTube IFrame Player API; on mobile, start muted when browsers block unmuted autoplay and let users unmute through native YouTube controls.
